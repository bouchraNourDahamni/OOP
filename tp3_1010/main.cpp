...
* 2.2Si on le considere pas , on affichera tous les produits du panier avec l'opérateur générique défini dans Produit et on perdra le polymorphisme des surcharges
**/
